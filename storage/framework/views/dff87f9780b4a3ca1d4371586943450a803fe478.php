    ...
    <div class="container p-5">
        <table class="table table-borderless">
            ...
            <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <thead>
                    <tr>
                        <td colspan="1"><?php echo e($question->number); ?>.</td>
                        <td colspan="6"><?php echo e($question->question); ?></td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td width="10%" style="text-align: center;">
                            <button type="button"
                                class="btn btn-outline-secondary rounded-circle rating-button <?php echo e($question->rat == 1 ? 'active' : ''); ?>"
                                data-question-id="<?php echo e($question->id); ?>" data-category="<?php echo e($category); ?>" data-rating="1">1</button>
                        </td>
                        <td width="10%" style="text-align: center;">
                            <button type="button"
                                class="btn btn-outline-secondary rounded-circle rating-button <?php echo e($question->rat == 2 ? 'active' : ''); ?>"
                                data-question-id="<?php echo e($question->id); ?>" data-category="<?php echo e($category); ?>" data-rating="2">2</button>
                        </td>
                        <td width="10%" style="text-align: center;">
                            <button type="button"
                                class="btn btn-outline-secondary rounded-circle rating-button <?php echo e($question->rat == 3 ? 'active' : ''); ?>"
                                data-question-id="<?php echo e($question->id); ?>" data-category="<?php echo e($category); ?>" data-rating="3">3</button>
                        </td>
                        <td width="10%" style="text-align: center;">
                            <button type="button"
                                class="btn btn-outline-secondary rounded-circle rating-button <?php echo e($question->rat == 4 ? 'active' : ''); ?>"
                                data-question-id="<?php echo e($question->id); ?>" data-category="<?php echo e($category); ?>" data-rating="4">4</button>
                        </td>
                        <td width="10%" style="text-align: center;">
                            <button type="button"
                                class="btn btn-outline-secondary rounded-circle rating-button <?php echo e($question->rat == 5 ? 'active' : ''); ?>"
                                data-question-id="<?php echo e($question->id); ?>" data-category="<?php echo e($category); ?>" data-rating="5">5</button>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
...
<?php /**PATH C:\Web Programming\AOL Web Programming\campustar\resources\views/test/career-aptitude-test.blade.php ENDPATH**/ ?>