...
<body>
    ...
    <div class="container">
        ...
        <div class="new-forum mt-5">
            <div class="row">
                <div class="col-auto">
                    <img src="<?php echo e(asset('assets/profile/karina.png')); ?>" class="card-img-top" alt="..." style="width: 35px;">
                </div>
                <div class="col">
            ...
            <ul class="list-group list-group-flush">
                <a href="" class="text-decoration-none">
                    <li class="list-group-item list-forum">
                        <div class="row">
                            <div class="col-auto">
                                <img src="<?php echo e(asset('assets/profile/yujin.png')); ?>" class="card-img-top" alt="..." style="width: 35px;">
                            </div>  
                            <div class="col">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <img class="mt-1" src="<?php echo e(asset('assets/komen.png')); ?>" alt="">
                ...
                <a href="" class="text-decoration-none">
                    <li class="list-group-item list-forum">
                        <div class="row">
                            <div class="col-auto">
                                <img src="<?php echo e(asset('assets/profile/winter.png')); ?>" class="card-img-top" alt="..." style="width: 35px;">
                            </div>
                            <div class="col">
                ...
                <a href="" class="text-decoration-none">
                    <li class="list-group-item list-forum">
                        <div class="row">
                            <div class="col-auto">
                                <img src="<?php echo e(asset('assets/profile/sana.png')); ?>" class="card-img-top" alt="..." style="width: 35px;">
                            </div>
                            <div class="col">
                ...
                <a href="" class="text-decoration-none">
                    <li class="list-group-item list-forum">
                        <div class="row">
                            <div class="col-auto">
                                <img src="<?php echo e(asset('assets/profile/mina.png')); ?>" class="card-img-top" alt="..." style="width: 35px;">
                            </div>
                            <div class="col">
                ...
                <a href="" class="text-decoration-none">
                    <li class="list-group-item list-forum">
                        <div class="row">
                            <div class="col-auto">
                                <img src="<?php echo e(asset('assets/profile/yuqi.png')); ?>" class="card-img-top" alt="..." style="width: 35px;">
                            </div>
                            <div class="col">
                ...
                <a href="" class="text-decoration-none">
                    <li class="list-group-item list-forum">
                        <div class="row">
                            <div class="col-auto">
                                <img src="<?php echo e(asset('assets/profile/lily.png')); ?>" class="card-img-top" alt="..." style="width: 35px;">
                            </div>
                            <div class="col">
...
</html><?php /**PATH C:\Web Programming\AOL Web Programming\campustar\resources\views/forum.blade.php ENDPATH**/ ?>