<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    <div class="container">
        <a class="navbar-brand" href="/">
            <img src="<?php echo e(asset('assets/logo-navbar.png')); ?>" alt="Campustar" style="height: 30px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <div class="mx-auto d-flex"> 
                ...
                <form class="d-flex me-auto" action="<?php echo e(route('search')); ?>" method="GET"> 
            ...
            <?php if(Auth::check()): ?>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color: black; font-weight: 700;">
                        <img src="<?php echo e(asset('images/' . Auth::user()->photo)); ?>" class="rounded-circle me-2 nav-profile-pic" style="width: 28px; height: 28px;" alt="Profil">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end mt-2" aria-labelledby="navbarDropdown">
                        ...
                        <li>
                            <form action="<?php echo e(url('/keluar')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Web Programming\AOL Web Programming\campustar\resources\views/components/navbar2.blade.php ENDPATH**/ ?>