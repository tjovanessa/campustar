    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-4 mt-5">
                ...
                <form action="<?php echo e(route('auth.authenticate')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control mb-2" name="email" id="email" placeholder="Masukkan email Anda" style="border-width: 2px;" value="<?php echo e(old('email')); ?>">
...
<?php /**PATH C:\Web Programming\AOL Web Programming\campustar\resources\views/auth/login.blade.php ENDPATH**/ ?>